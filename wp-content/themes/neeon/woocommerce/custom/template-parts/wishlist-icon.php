...
$title_before = esc_html__( 'Add to Wishlist', 'neeon' );
$title_after  = esc_html__( 'Aleady exists in Wishlist! Click here to view Wishlist', 'neeon' );
...
$html .= '<img class="ajax-loading" alt="spinner" src="'.NeeonTheme_Helper::get_img( 'spinner2.gif' ).'">';

if ( $text ) {
	$html .= '<span>' . esc_html__( 'WishList', 'neeon' ) . '</span>';
}
