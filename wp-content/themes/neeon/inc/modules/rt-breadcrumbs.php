...
if( ! function_exists( 'neeon_breadcrumbs' )){

	function neeon_breadcrumbs(){
		...
		$home_text  = esc_html__( 'Home', 'neeon' );
		...
		if ( ! is_home() && ! is_front_page() || is_paged() ){
			...
			elseif ( is_singular() ){			
				...
				if ( get_post_type() == 'post' ){
					...
					$category = neeon_get_primary_category_id();
					$category = get_category( $category );
