...
function create_dynamic_post_shortcode_archive($atts_archive)
{
	...
	//var_dump($get_shortcode_atts_archive['month']);
	if(!is_numeric($get_shortcode_atts_archive['month'])){
	$get_shortcode_atts_archive['month'] = date_parse($get_shortcode_atts_archive['month']);
	$get_shortcode_atts_archive['month'] = $get_shortcode_atts_archive['month']['month'];
	}
	//var_dump($get_shortcode_atts_archive['month']);
